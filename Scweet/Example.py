...
# data = scrape(words=['I was diagonised'], since="2021-10-01", until="2021-10-05", from_account=None, interval=1,
...
data = scrape(words=["I was diagnosed PTSD"], since="2022-01-01", until="2022-04-01", from_account=None, interval=1,
              headless=False, display_type="Top", save_images=False, lang="en",
              resume=False, filter_replies=True, proximity=False, geocode="40.7143528,-74.0059731,800km")
